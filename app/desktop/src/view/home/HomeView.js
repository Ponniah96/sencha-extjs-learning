...
<br>
- <span style="color:red; text-decoration: line-through">ext-gen viewpackage employee</span> (shortcut: <span style="color:red;text-decoration:line-through">ext vp employee</span>)
<br>
<span>Create a new folder under 'view' called 'employee' with 4 files: EmployeeView.js, EmployeeViewController.js, EmployeeViewModel.js, EmployeeView.scss</span>
<br>
<span>Add the new view to the menu in 'app/desktop/src/view/main/MainViewModal.js'</span>
<br><br>
Simple Theming:
<br><br>
